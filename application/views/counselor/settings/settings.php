...
<div class="main-container">
				...
				<div class="card-body">
					<div class="account-settings">
						...
						<div class="setting-links">
							<a href="<?php echo site_url('counselor/settings?str=profile'); ?>">
								<i class="icon-user"></i>
								Profile&nbsp;&nbsp;&nbsp;
							...
							<a href="<?php echo site_url('counselor/settings?str=updatePassword'); ?>">
	...
	<form action="<?php echo site_url('counselor/updateProfilePicture?userID='.$myProfile['userID']); ?>" method="post" enctype="multipart/form-data">
		...
		<div class="col-lg-9 col-sm-12 col-12">
			<div class="card h-100">
				...
				<div class="card-body">
					<?php if ($this->input->get('str') == 'profile'): ?>
						<form action="<?php echo site_url('counselor/updateProfile?userID='.$this->session->userdata('userID')); ?>" method="post">
							<div class="row gutters">
