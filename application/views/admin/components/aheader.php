						...
						<ul>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="<?php echo site_url('/admin'); ?>" <?php if ($isActiveSideBar == 'isForDashboard'){echo 'class="current-page"'; } ?>>Admin Dashboard</a>
										</li>
										<li>
											<a href="<?php echo site_url('/admin/user_management'); ?>" <?php if ($isActiveSideBar == 'isForUsersManagement'){echo 'class="current-page"'; } ?>>Users Management</a>
										</li>
										<li>
											<a href="<?php echo site_url('/question') ?>" <?php if ($isActiveSideBar == 'isForQuestions'){echo 'class="current-page"'; } ?>>Questionnaire Management</a>
										</li>
										<li>
											<a href="<?php echo site_url('/admin/department'); ?>" <?php if ($isActiveSideBar == 'isForDepartmentManagement'){echo 'class="current-page"'; } ?>>Department Management</a>
										</li>
										<li>
