...
<div class="main-container">
				...
				<div class="card-body">
					<div class="account-settings">
						...
						<div class="setting-links">
							<a href="<?php echo site_url('student/settings?str=profile'); ?>">
								<i class="icon-user"></i>
								Profile&nbsp;&nbsp;&nbsp;
							...
							<a href="<?php echo site_url('student/settings?str=updatePassword'); ?>">
	...
	<form action="<?php echo site_url('student/updateProfilePicture?userID='.$myProfile['userID']); ?>" method="post" enctype="multipart/form-data">
		...
		<div class="col-lg-9 col-sm-12 col-12">
			<div class="card h-100">
				...
				<div class="card-body">
					<?php if ($this->input->get('str') == 'profile'): ?>
						<form action="<?php echo site_url('student/updateProfile?userID='.$this->session->userdata('userID')); ?>" method="post">
							<div class="row gutters">
									...
									<div class="row gutters">
										<div class="col-sm-12">
											<div class="form-group">
												...
												<select class="form-control" name="courseID" required id="course">
									                <?php foreach ($courses as $course): ?>
									                  <option value="<?php echo ucwords($course['cID']); ?>" <?php if ($course['cID'] == $myProfile['courseID']){echo 'selected';}?>>
					...
					<?php elseif ($this->input->get('str') == 'updatePassword'): ?>
						<form action="<?php echo site_url('counselor/updatePassword?userID='.$this->session->userdata('userID')); ?>" method="post">
							<div class="row gutters">
								<div class="col-sm-12 col-12">
									<div class="row gutters">
										<div class="col-sm-6">
